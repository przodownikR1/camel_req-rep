...
public class LongRunningMockTaskTest extends CamelHelperTest {

    @Override
    protected String setContextResourceFile() {
        return "longRunningMockComponentTest.xml";
    }
    ...
    public void should_long_running_task_work() throws Exception {
        MockEndpoint mock = getMockEndpoint("mock:myMock");
        mock.whenAnyExchangeReceived(new Processor(){
            @Override
            public void process(Exchange exchange) throws Exception {
                exchange.getIn().setHeader("WARNING", "CAMEL_DOWN");   
            }
        }); 
